# Onimusha: Way of the Sword — Unofficial Guide

This site targets `https://onimushawayofthesword.pro` and is generated from the V3
Next.js seed template by the `one-click-builder` role. It provides
